...
const api = {
  ...
  directOllamaQuery: async (prompt, onStream, systemPrompt, model) => {
    ...
    try {
      ...
      const result = await electron.ipcRenderer.invoke("ollama:direct-query", prompt, systemPrompt, model);
